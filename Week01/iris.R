library(readr)
iris <- read_csv("C:/Users/jessi/Documents/PGSS CS Lab Course/CMU_PGSS2023_CSLab/iris.csv", 
...
save_plot("C:/Users/jessi/Documents/PGSS CS Lab Course/CMU_PGSS2023_CSLab/iris.png", p1, base_height=4, base_width=4, limitsize=FALSE)